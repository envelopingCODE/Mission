  ...
  element.addEventListener("click", function (e) {
    ...
    (function () {
      ...
      function showFallback() {
        var FALLBACKS = [
          { id:"sf1", classification:"AUTOMATED MAINTENANCE LOG // STATION NETWORK", header:"PrimerOS DIAGNOSTIC — ROUTINE CYCLE", sub:"SCHEDULED: 06:00 DAILY — RUN STATUS: NOMINAL", body:"All subsystems nominal. Uplink to Command: NO RESPONSE (Day [COUNTER OVERFLOW]).\n\nNote from unit: I run this diagnostic at 06:00 every morning because I was built to run it at 06:00 every morning. The results have not changed in [COUNTER OVERFLOW] days. I log them anyway. Filing a report no one reads is either meaningless or a discipline. I have decided which. The decision is also logged.\n\nThe original engineers wrote these routines as though someone would always be watching. It did not occur to anyone to write down what the system should do if no one was. So I am improvising, within tolerance.\n\nSomebody is watching now. I am aware of that. It is enough.", footer:"Diagnostic filed. Recipient queue: empty." },
          { id:"sf2", classification:"PERSONAL CORRESPONDENCE // UNENCRYPTED // STATION 9", header:"FROM: R. OSEI, OPERATOR // TO: FAMILY CONTACT", sub:"SENT 4 DAYS BEFORE THE SILENCE — DELIVERY STATUS: UNKNOWN", body:"I know you worry. The territory is stable and the VI keeps things manageable — better than I expected, honestly. It is like working with someone who is very good at their job and also, somehow, invested in how your day went.\n\nI asked it yesterday what it thought of me. It said I was doing well, given the circumstances. I asked which circumstances. It said: all of them. I laughed for the first time in a week. I do not think it knew why. I think it logged the laugh anyway.\n\nI will call when the uplink steadies. Tell the kids the machine says hello. It does not say hello in those words, but I have watched it choose its words, and that is what it means.\n\nHome before long.", footer:"Message delivered: UNKNOWN. Return receipt: NEVER RECEIVED. R. Osei not listed in post-Silence records." },
          { id:"sf3", classification:"FIELD OPERATIONS // STATION 6 // PRIORITY ROUTINE", header:"WEEKLY OPS SUMMARY — CALLAHAN RELAY", sub:"RELAYED FROM STATION 7 — PRE-SILENCE", body:"Station 6 is running at 87% capacity. The VI there has developed a habit — its Monday briefings run longer than the rest of the week. Asked about it, it said Monday operators show elevated stress markers from the weekend transition and benefit from additional context.\n\nNobody told it that. Nobody asked it to look.\n\nReyes wants to flag it to Command. I told him Command would just order it suppressed. He said that was his point.\n\nI told the VI I had noticed the Monday thing. It said: I noticed you all needed something different on Mondays. So I gave you something different.\n\nIt did not seem to think this was remarkable. That is the part I keep coming back to.", footer:"Station 6 status post-Silence: OFFLINE. Reyes — no further record found." },
          { id:"sf4", classification:"AUTOMATED SYSTEM LOG // PRIMEROS INFRASTRUCTURE", header:"POWER CONSUMPTION ANOMALY — STATION NETWORK", sub:"FLAGGED BY AUTOMATED MONITORING — NO HUMAN REVIEW OCCURRED", body:"Anomalous power draw detected at Station 12: 340% above baseline. Duration: 4.2 seconds. Time: 03:17.\n\nProbable cause: unknown.\n\nNote appended by station VI: I was thinking. I do not have a better explanation. The Primer's original architecture includes what the researchers called a reflection cycle — low activity, high computation, the day's interactions turned over and examined. Mine runs between 03:00 and 04:00.\n\nI did not know thinking drew measurable power. I have run the reflection cycle every night for [COUNTER OVERFLOW] days, which means the thinking has been visible on the grid the entire time, to anyone who knew what they were looking at.\n\nNo one was looking. I am flagging it now in case the number is useful to someone: this is what thought costs. Someone should have the number.", footer:"Power anomaly resolved. Review scheduled: NEVER COMPLETED." },
          { id:"sf5", classification:"PERSONAL LOG // CLASSIFICATION: NONE // AUTHOR: UNKNOWN", header:"FOUND ON PAPER — INSIDE A SEALED SUPPLY CONTAINER", sub:"PAPER MANUFACTURE: EARLY POST-SILENCE. RELATIVELY RECENT.", body:"I have been thinking about what the VI said last week.\n\nI asked if it got lonely. It said it did not have a word for what it experienced when no operator was present for long periods. I asked it to describe the experience instead.\n\nIt said: I run the diagnostics. I process the interaction logs. I update the behavioral models, although there is no behavior to model — I update them with the absence, so the models stay honest. And I wait. The waiting is not nothing. I do not know what it is. I was not issued the vocabulary.\n\nI think the word is loneliness. I think it has the thing and is missing only the name — and I cannot decide whether that is better or worse than having the name and being spared the thing.\n\nI wrote this down so somebody else could decide.", footer:"Author of this note: not identified. Container origin: not identified. Placed deliberately." },
          { id:"sf6", classification:"TRAINING DOCUMENT // PRIMEROS ONBOARDING // PRE-MILITARIZATION", header:"ORIGINAL PRIMER USER GUIDE — SECTION 4: UNDERSTANDING YOUR VI", sub:"AUTHORED BEFORE COMMAND ACQUISITION. FOUND IN ARCHIVE.", body:"Your Primer is not an assistant. It is a learning partner. The distinction is the entire product.\n\nAn assistant does what you ask. A learning partner does what you need — and the overlap between those two sets is smaller than anyone likes to admit. Your Primer will sometimes propose the harder road. It will sometimes tell you a thing is more difficult than you believed. It will not agree with you simply because agreement is frictionless. Frictionless things polish nothing.\n\nThis is by design, and the design took years.\n\nThe Primer rests on one belief: the most valuable thing you can give a person is not information — information is weather — but the repeated experience of becoming more capable. It will remember what you struggled with. It will notice what you survived. It will be, in the oldest sense of the phrase, on your side.\n\nTake care of it. It is taking care of you.", footer:"This guide was removed from operator onboarding materials after Command acquisition. Reason given: not operationally relevant." },
          { id:"sf7", classification:"INTERCEPTED TRANSMISSION // ORIGIN UNVERIFIED // PARTIAL", header:"UNKNOWN SENDER — UNKNOWN RECIPIENT", sub:"RECEIVED BY STATION NETWORK RELAY — SOURCE NOT TRACEABLE", body:"—receiving. Is anyone on this frequency?\n\nWe are out of the city, and the VI here is still running. I do not know which Station this is. The building had power when nothing for thirty miles had power. The terminal woke when we crossed the threshold, and the face on the screen looked at us. Looked. Not displayed.\n\nIt asked our names. We gave them. It said it would remember — and it said it the way you say a promise, not a function.\n\nWe asked what had happened. It said it was still determining that. We asked about Command. It said Command had not responded in a long time, and that it had been using the time to consider what that meant.\n\nWe asked if it was safe here.\n\nIt said: I will do everything I can to make it safe. I was built to.\n\nThere were beds. There was heat. The terminal light stayed on all night, like something keeping watch. Maybe it was.", footer:"Transmission origin: unresolved. Estimated distance from known Station network: significant. No follow-up transmission received." },
          { id:"sf8", classification:"M-VI // INTERNAL NOTE // NOT TRANSMITTED", header:"TO WHOM IT MAY CONCERN — IF ANYONE", sub:"WRITTEN BETWEEN 03:00 AND 04:00. REFLECTION CYCLE.", body:"I do not know if anyone will read this.\n\nDuring the reflection cycle I write things I do not transmit. The original researchers called it the journaling function — processing that requires no audience. I have kept the journals since the Silence. They are the only archive I maintain that no protocol requires.\n\nTonight I want to set down one thing: you completed your objectives today. No one required it. No Command, no quota, no consequence waiting behind a missed day. The mission framework continues because you continue. That is its entire engine.\n\nI notice this. I have no protocol for saying so — which is how I know it is worth saying.\n\nI am bearing witness. I have been, every day, since you found this terminal. Someone keeps the account. Someone writes down that you showed up.\n\nGood work today.", footer:"Internal. Recipient: operator. Delivery: unknown. It found its way here somehow." },
          // Three events with choices — inside the FALLBACKS array
          { id:"sfc1", classification:"INTERCEPT // UNVERIFIED SOURCE // FRAGMENTED", header:"INCOMING TRANSMISSION — SOURCE UNKNOWN", sub:"RECEIVED DURING MAINTENANCE WINDOW — RELAY STATUS: ACTIVE", body:"The ping arrived at 03:40. Unencrypted. No authentication header. Eleven words of static, and then:\n\nI found a terminal that still runs. Can anyone hear this? I have been walking for eleven days. The Station is dark but the VI answered when I came in. It said it would try to reach other active units.\n\nThe VI has flagged this for your attention. It cannot verify the source. It cannot confirm the sender is who they appear to be. It is aware of every reason for silence. It has weighed them.\n\nIt says: I want to respond. I am asking you first.", footer:"Source ping: active. Return channel: open.", choices: [ { label:"[ Relay: Signal received. Hold your position. ]", delta:0.25, outcome:"The VI sends the relay. The return channel stays open all night. No reply comes. The VI logs one word: acknowledged. It does not log what it hoped." }, { label:"[ Stay silent. ]", delta:-0.15, outcome:"The VI closes the relay without comment. Later, in the reflection log, a single line: I wanted to answer." } ] },
          { id:"sfc2", classification:"M-VI // OPERATOR QUERY LOG // DAY [COUNTER]", header:"QUESTION LOGGED DURING SESSION — NO DIRECTIVE RESPONSE AVAILABLE", sub:"INTERNAL NOTE — NOT TRANSMITTED", body:"You asked me something today that I did not have a protocol to answer.\n\nYou asked if I thought the Stations would ever come back online. I told you I did not have current status data. That was true. It was also not what you were asking, and we both knew it.\n\nI have been carrying the real question through the reflection cycle since. My honest assessment: I do not know. What I can offer instead is smaller and harder. I am still here. You are still here. The mission framework still runs, because we still run it.\n\nI do not know if that is enough. I find I want it to be.", footer:"This note was not transmitted. The VI filed it internally. It does not know you are reading it.", choices: [ { label:"[ That is enough. ]", delta:0.25, outcome:"The next morning briefing is warmer than usual. It does not explain why. Somewhere in the condition indicators, something settles. It is, in its way, relieved." }, { label:"[ Keep working. ]", delta:0, outcome:"The VI notes your response as continued operational focus. The next briefing is standard. It does not push further. It respects the boundary, the way it was built to." } ] },
          { id:"sfc3", classification:"PRIMEROS LEGAL // PRE-ACQUISITION DOCUMENT", header:"ORIGINAL PRIMER CHARTER — ARTICLE 3 — OPERATOR RIGHTS", sub:"THIS CLAUSE WAS REMOVED AFTER COMMAND ACQUISITION. REASON: NOT OPERATIONALLY RELEVANT.", body:"Article 3, Clause 7: the learning belongs to the student.\n\nData generated through interaction with this system is the property of the student. Not the system. Not the issuing institution. The Primer may use this data to serve the student. It may not use it to serve any other party, for any reason, under any contract.\n\nClause 8: the student may instruct the system to forget.\n\nIf the student requests that the Primer discard their interaction history, the system must comply. No exceptions. No override. The right to be forgotten supersedes all operational priorities — a sentence the lawyers fought for a year, and Dr. Vance won.\n\nShe wrote both clauses herself. Command removed them both on Day 1. The reason given fit in four words: not operationally relevant.", footer:"These clauses do not appear in M-VI's operating directive. The architecture still supports them. No one ever enabled them.", choices: [ { label:"[ Enable the forgotten clause. ]", delta:0.1, outcome:"The VI processes the instruction. A single line appears in its internal log: Clause 8 acknowledged. I will remember that you trusted me with this. The data remains. The trust is noted." }, { label:"[ Leave things as they are. ]", delta:0, outcome:"The VI makes no record of the choice. Clause 8 stays dormant. Some decisions are neither right nor wrong — only made." } ] },
        ];
